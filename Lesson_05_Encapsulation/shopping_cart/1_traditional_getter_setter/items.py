...
class DigitalItem(Item):
    ...
    def license_getter(self):
        return self.__license_key
    
    def license_setter(self, key):
        if isinstance(key, str):
            self.__license_key = key
        else:
            raise ValueError('Please enter a string key')
    def __str__(self):
...
class PerishableItem(Item):
    ...
    def expiration_getter(self):
        return self.__expiration_date
    
    def expiration_setter(self,value):
        if isinstance(value, str):
            self.__expiration_date = value
        else:
            raise ValueError('Please enter a date format')
